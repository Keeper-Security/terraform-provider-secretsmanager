...
func TestAccResourceMembership_create(t *testing.T) {
	...
	config := fmt.Sprintf(`
		resource "secretsmanager_membership" "%v" {
			folder_uid = "%v"
			uid = "%v"
			title = "%v"
			notes = "%v"
...
func TestAccResourceMembership_update(t *testing.T) {
	secretType := "membership"
	secretFolderUid := testAcc.getTestFolder()
	secretUid := core.GenerateUid()
	_, secretTitle := testAcc.getRecordInfo(secretType)
...
func TestAccResourceMembership_deleteDetection(t *testing.T) {
	secretType := "membership"
	secretFolderUid := testAcc.getTestFolder()
	secretUid := core.GenerateUid()
	_, secretTitle := testAcc.getRecordInfo(secretType)
...
func TestAccResourceMembership_import(t *testing.T) {
	secretType := "membership"
	secretFolderUid := testAcc.getTestFolder()
	secretUid := core.GenerateUid()
	_, secretTitle := testAcc.getRecordInfo(secretType)
