...
var (
	_ ephemeral.EphemeralResource              = &ephemeralFile{}
	_ ephemeral.EphemeralResourceWithConfigure = &ephemeralFile{}
)
...
type ephemeralFileModel struct {
...
func NewEphemeralFile() ephemeral.EphemeralResource {
	return &ephemeralFile{}
}

func (e *ephemeralFile) Metadata(_ context.Context, req ephemeral.MetadataRequest, resp *ephemeral.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_file"
}

func (e *ephemeralFile) Schema(_ context.Context, _ ephemeral.SchemaRequest, resp *ephemeral.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Use this ephemeral resource to read a file record from Keeper Secrets Manager. Values are never stored in state.",
...
func (e *ephemeralFile) Configure(_ context.Context, req ephemeral.ConfigureRequest, resp *ephemeral.ConfigureResponse) {
...
func (e *ephemeralFile) Open(ctx context.Context, req ephemeral.OpenRequest, resp *ephemeral.OpenResponse) {
	var data ephemeralFileModel
