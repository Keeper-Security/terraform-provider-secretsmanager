...
func TestAccResourceBankCard_create(t *testing.T) {
	secretType := "bankCard"
	...
	config := fmt.Sprintf(`
		resource "secretsmanager_bank_card" "%v" {
			folder_uid = "%v"
			uid = "%v"
			title = "%v"
			notes = "%v"
...
func TestAccResourceBankCard_update(t *testing.T) {
	secretType := "bankCard"
	secretFolderUid := testAcc.getTestFolder()
	secretUid := core.GenerateUid()
	_, secretTitle := testAcc.getRecordInfo(secretType)
...
func TestAccResourceBankCard_deleteDetection(t *testing.T) {
	secretType := "bankCard"
	secretFolderUid := testAcc.getTestFolder()
	secretUid := core.GenerateUid()
	_, secretTitle := testAcc.getRecordInfo(secretType)
...
func TestAccResourceBankCard_import(t *testing.T) {
	secretType := "bankCard"
	secretFolderUid := testAcc.getTestFolder()
	secretUid := core.GenerateUid()
	_, secretTitle := testAcc.getRecordInfo(secretType)
